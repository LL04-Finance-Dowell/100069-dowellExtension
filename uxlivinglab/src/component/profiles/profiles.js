        ...
        <div className="{ props.text }">
          <button className="logout" style={{ width: 270, marginLeft: 4 }}>
            <i
              ...
              style={{ fontSize: 20, fontStyle: "normal" }}
            >
              My Profile
            </i>
          </button>
      ...
      <div id="all">
        <div className="all-border">
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow1: !arrows.showArrow1 })}
            >
              <i
                ...
                className={
                  arrows.showArrow1
                    ? "fas inc fa-angles-up"
                    : "fas inc fa-angles-down"
                }
                onClick={() => hideComponent("show1")}
              ></i>
              <p className={arrows.showArrow1 ? "selected" : "unselected"}>
                {" "}
                01. My Profile
              </p>
            </div>
          ...
          <div className={arrows.showArrow1 ? "spaceShow" : "spaceHide"}></div>
          {/* {arrows.showArrow1 && <div className= ></div>} */}

          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow2: !arrows.showArrow2 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow2 ? "selected" : "unselected"}>
                02.Set Password
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow3: !arrows.showArrow3 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow3 ? "selected" : "unselected"}>
                03.Device IDs
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow4: !arrows.showArrow4 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow4 ? "selected" : "unselected"}>
                04.Personal IDs
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow5: !arrows.showArrow5 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow5 ? "selected" : "unselected"}>
                05.References
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow6: !arrows.showArrow6 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow6 ? "selected" : "unselected"}>
                06.ID Verification
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow7: !arrows.showArrow7 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow7 ? "selected" : "unselected"}>
                07.My Organisation
              </p>
            </div>
          </div>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow8: !arrows.showArrow8 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow8 ? "selected" : "unselected"}>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow9: !arrows.showArrow9 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow9 ? "selected" : "unselected"}>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow10: !arrows.showArrow10 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow10 ? "selected" : "unselected"}>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow11: !arrows.showArrow11 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow11 ? "selected" : "unselected"}>
          ...
          <div className="element-container">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow12: !arrows.showArrow12 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow12 ? "selected" : "unselected"}>
                12.Usage Profile
              </p>
            </div>
          </div>
          ...
          <div className="element-container last">
            <div
              className="items"
              onClick={() => setaArrows({ showArrow13: !arrows.showArrow13 })}
            >
              <i
                aria-hidden="true"
                className={
              ...
              <p className={arrows.showArrow13 ? "selected" : "unselected"}>
